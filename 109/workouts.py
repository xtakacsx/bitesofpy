...
def get_workout_motd(day: str):
    ...
    workout_day = day.lower().capitalize()
    if workout_day in workout_schedule.keys():
        if workout_schedule[workout_day] == 'Rest':
            return chill
        else:
            return go_train.format(workout_schedule[workout_day])
    else:
        raise KeyError
